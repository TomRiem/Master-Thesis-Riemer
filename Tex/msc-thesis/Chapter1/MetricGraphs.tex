...
\begin{definition}[{\cite[Definition~1.3.2.]{BerkolaikoKuchment:2013}}]\label{metric graph equilateral}
...
%So, now one can imagine the graph Γ as a one-dimensional simplicial complex, each 1D simplex (edge) of which is equipped with a smooth structure, with singularities arising at junctions (vertices) 
